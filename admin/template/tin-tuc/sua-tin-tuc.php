...
<form action="" method="post" id="updateNews" enctype="multipart/form-data">
    ...
    <div class="rowNodeContentPage">
        ...
        <div class="boxNodeContentPage">
            ...
            <p class="titleRightNCP">Schema :</p>
            <p style="width:100%;margin-top:5px;"><textarea class="longtxtNCP1 ckeditor1" id="editor1" name="news_sub_info2"><?= $row['news_sub_info2']?></textarea></p>

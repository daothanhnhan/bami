    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 gb-single-blog_ruouvang-right">
                ...
                <div class="gb-single-blog_ruouvang-right-info">
                    <ul>
                        ...
                        <li><i class="fa fa-clock-o" aria-hidden="true"></i><a href="#"> <?= date('F d, Y', strtotime($row['news_created_date'])) ?></a></li>
            ...
            <div class="col-md-4 gb-blog-left">
                ...
                <?php // tin tuc moi include DIR_SIDEBAR."MS_SIDEBAR_H2D_0003.php";?>
                <?php include DIR_SIDEBAR."MS_SIDEBAR_H2D_0011.php";?>
            </div>
        </div>
    </div>
</div>